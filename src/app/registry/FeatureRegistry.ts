...
FeatureRegistry.register({ id: "shorts", name: "Fresh Flow", route: "/flow", searchable: false, lazyLoader: () => import("../../features/shorts/components/FreshFlow").then((m) => ({ default: m.default })) });
