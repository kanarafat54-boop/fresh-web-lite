    ...
    <main className="universal-profile">
      ...
      <section className="profile-hero">
        ...
        <div className="profile-primary-actions">
          ...
          <button type="button" onClick={() => window.dispatchEvent(new CustomEvent("fresh-route", { detail: "creator" }))}>＋ Create</button>
