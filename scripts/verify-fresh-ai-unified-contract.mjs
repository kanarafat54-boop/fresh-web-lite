...
for(const required of ["createFreshAIIntelligenceGateway","fresh_ai_memory","fresh_ai_pipeline_events","persist(","generateFreshAIImage","/v1/images/generations"]){if(!ask.includes(required))throw new Error(`Missing canonical Fresh AI ask contract: ${required}`)}
